  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
      ...
      <div className="gradient-border bg-dark-light p-6 relative overflow-hidden">
        ...
        <div className="relative">
          <p className="text-gray-400 text-sm mb-2">可用余额 (USDT)</p>
      ...
      <div className="gradient-border bg-dark-light p-6 relative overflow-hidden">
        ...
        <div className="relative">
          <p className="text-gray-400 text-sm mb-2">累计收益 (USDT)</p>
          <h3 className="text-2xl md:text-3xl font-bold mb-2">1,245.89</h3>
          <div className="flex items-center text-success text-sm">
            <i className="fa fa-arrow-up mr-1"></i>
            <span>12.5%</span>
            <span className="text-gray-400 ml-1">年化收益率</span>
          </div>
        </div>
      </div>
    </div>
